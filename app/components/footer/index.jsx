...
const Footer = ({...otherProps}) => {
    ...
    return (
        <Box as="footer" {...styles.container} {...otherProps} className="footer-wrapper">
            <Box {...styles.content} as="section" className="footer-container">
...
const Subscribe = ({...otherProps}) => {
    ...
    const intl = useIntl()
    return (
        <Box {...styles.subscribe} {...otherProps} className="subscription-form">
